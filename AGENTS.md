This repository is for a Reticulum Network System connector for Signal k.

We should strive to match and surpass the `signalk-meshtastic` plugin which can be found in the `signalk-meshtastic/` folder.
